 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hp(t,e,n=!1){const s="signIn",r=await lp(t,s,e),i=await Ts._fromIdTokenResponse(t,s,r);return n||await t._updateCurrentUser(i.user),i}async function nb(t,e){return hp(Oo(t),e)}function Gk(t,e,n){return nb(Ae(t),Fs.credential(e,n))}function Qk(t,e){return sb(Ae(t),null,e)}async function sb(t,e,n){const{auth:s}=t,i={idToken:await t.getIdToken(),returnSecureToken:!0};e&&(i.email=e),n&&(i.password=n);const o=await bs(t,cp(s,i));await t._updateTokensIfNecessary(o,!0)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xk(t,e){return Ae(t).setPersistence(e)}function rb(t,e,n,s){return Ae(t).onIdTokenChanged(e,n,s)}function ib(t,e,n){return Ae(t).beforeAuthStateChanged(e,n)}function Yk(t,e,n,s){return Ae(t).onAuthStateChanged(e,n,s)}function Jk(t){return Ae(t).signOut()}const Yi="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gm="firebasestorage.googleapis.com",Qm="storageBucket",EA=2*60*1e3,bA=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${this.customData.serverResponse}`:this.message=this._baseMessage}}function Oa(t){return"storage/"+t}function ol(){const t="An unknown error occurred, please check the error payload for server response.";return new Se("unknown",t)}function TA(t){return new Se("object-not-found","Object '"+t+"' does not exist.")}function IA(t){return new Se("quota-exceeded","Quota for bucket '"+t+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function SA(){const t="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new Se("unauthenticated",t)}function CA(){return new Se("unauthorized-app","This app does not have permission to access Firebase Storage on this project.")}function AA(t){return new Se("unauthorized","User does not have permission to access '"+t+"'.")}function kA(){return new Se("retry-limit-exceeded","Max retry time for operation exceeded, please try again.")}function RA(){return new Se("canceled","User canceled the upload/download.")}function DA(t){return new Se("invalid-url","Invalid URL '"+t+"'.")}function NA(t){return new Se("invalid-default-bucket","Invalid default bucket '"+t+"'.")}function OA(){return new Se("no-default-bucket","No default bucket found. Did you set the '"+Qm+"' property when initializing the app?")}function PA(){return new Se("cannot-slice-blob","Cannot slice blob for upload. Please retry the upload.")}function xA(){return new Se("no-download-url","The given file does not have any download URLs.")}function MA(t){return new Se("unsupported-environment",`${t} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function Dc(t){return new Se("invalid-argument",t)}function Xm(){return new Se("app-deleted","The Firebase app was deleted.")}function LA(t){return new Se("invalid-root-operation","The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function yr(t,e){return new Se("invalid-format","String does not match format '"+t+"': "+e)}function Ys(t){throw new Se("internal-error","Internal error: "+t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jA(t,e){const n=t>=500&&t<600,r=[408,429].indexOf(t)!==-1,i=e.indexOf(t)!==-1;return n||r||i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HA{constructor(e,n,s,r,i,o,a,c,u,l,h,f=!0){this.url_=e,this.method_=n,this.headers_=s,this.body_=r,this.successCodes_=i,this.additionalRetryCodes_=o,this.callback_=a,this.errorCallback_=c,this.timeout_=u,this.progressCallback_=l,this.connectionFactory_=h,this.retry=f,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise((g,y)=>{this.resolve_=g,this.reject_=y,this.start_()})}start_(){const e=(s,r)=>{if(r){s(!1,new _i(!1,null,!0));return}const i=this.connectionFactory_();this.pendingConnection_=i;const o=a=>{const c=a.loaded,u=a.lengthComputable?a.total:-1;this.progressCallback_!==null&&this.progressCallback_(c,u)};this.progressCallback_!==null&&i.addUploadProgressListener(o),i.send(this.url_,this.method_,this.body_,this.headers_).then(()=>{this.progressCallback_!==null&&i.removeUploadProgressListener(o),this.pendingConnection_=null;const a=i.getErrorCode()===qn.NO_ERROR,c=i.getStatus();if((!a||jA(c,this.additionalRetryCodes_))&&this.retry){const l=i.getErrorCode()===qn.ABORT;s(!1,new _i(!1,null,l));return}const u=this.successCodes_.indexOf(c)!==-1;s(!0,new _i(u,i))})},n=(s,r)=>{const i=this.resolve_,o=this.reject_,a=r.connection;if(r.wasSuccessCode)try{const c=this.callback_(a,a.getResponse());BA(c)?i(c):i()}catch(c){o(c)}else if(a!==null){const c=ol();c.serverResponse=a.getErrorText(),this.errorCallback_?o(this.errorCallback_(a,c)):o(c)}else if(r.canceled){const c=this.appDelete_?Xm():RA();o(c)}else{const c=kA();o(c)}};this.canceled_?n(!1,new _i(!1,null,!0)):this.backoffId_=FA(e,n,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,this.backoffId_!==null&&VA(this.backoffId_),this.pendingConnection_!==null&&this.pendingConnection_.abort()}}class _i{constructor(e,n,s){this.wasSuccessCode=e,this.connection=n,this.canceled=!!s}}function qA(t,e){e!==null&&e.length>0&&(t.Authorization="Firebase "+e)}function KA(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(e!=null?e:"AppManager")}function zA(t,e){e&&(t["X-Firebase-GMPID"]=e)}function WA(t,e){e!==null&&(t["X-Firebase-AppCheck"]=e)}function GA(t,e,n,s,r,i,o=!0){const a=Ym(t.urlParams),c=t.url+a,u=Object.assign({},t.headers);return zA(u,e),qA(u,n),KA(u,i),WA(u,s),new HA(c,t.method,u,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,r,o)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function QA(){return typeof BlobBuilder!="undefined"?BlobBuilder:typeof WebKitBlobBuilder!="undefined"?WebKitBlobBuilder:void 0}function XA(...t){const e=QA();if(e!==void 0){const n=new e;for(let s=0;s<t.length;s++)n.append(t[s]);return n.getBlob()}else{if(cl())return new Blob(t);throw new Se("unsupported-environment","This browser doesn't seem to support creating Blobs")}}function YA(t,e,n){return t.webkitSlice?t.webkitSlice(e,n):t.mozSlice?t.mozSlice(e,n):t.slice?t.slice(e,n):null}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function JA(t){if(typeof atob=="undefined")throw MA("base-64");return atob(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wt={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Pa{constructor(e,n){this.data=e,this.contentType=n||null}}function Jm(t,e){switch(t){case wt.RAW:return new Pa(Zm(e));case wt.BASE64:case wt.BASE64URL:return new Pa(ey(t,e));case wt.DATA_URL:return new Pa(ek(e),tk(e))}throw ol()}function Zm(t){const e=[];for(let n=0;n<t.length;n++){let s=t.charCodeAt(n);if(s<=127)e.push(s);else if(s<=2047)e.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(n<t.length-1&&(t.charCodeAt(n+1)&64512)===56320))e.push(239,191,189);else{const i=s,o=t.charCodeAt(++n);s=65536|(i&1023)<<10|o&1023,e.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?e.push(239,191,189):e.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(e)}function ZA(t){let e;try{e=decodeURIComponent(t)}catch{throw yr(wt.DATA_URL,"Malformed data URL.")}return Zm(e)}function ey(t,e){switch(t){case wt.BASE64:{const r=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(r||i)throw yr(t,"Invalid character '"+(r?"-":"_")+"' found: is it base64url encoded?");break}case wt.BASE64URL:{const r=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(r||i)throw yr(t,"Invalid character '"+(r?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=JA(e)}catch(r){throw r.message.includes("polyfill")?r:yr(t,"Invalid character found")}const s=new Uint8Array(n.length);for(let r=0;r<n.length;r++)s[r]=n.charCodeAt(r);return s}class ty{constructor(e){this.base64=!1,this.contentType=null;const n=e.match(/^data:([^,]+)?,/);if(n===null)throw yr(wt.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=n[1]||null;s!=null&&(this.base64=nk(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=e.substring(e.indexOf(",")+1)}}function ek(t){const e=new ty(t);return e.base64?ey(wt.BASE64,e.rest):ZA(e.rest)}function tk(t){return new ty(t).contentType}function nk(t,e){return t.length>=e.length?t.substring(t.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ny(t){let e;try{e=JSON.parse(t)}catch{return null}return $A(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sk(t){if(t.length===0)return null;const e=t.lastIndexOf("/");return e===-1?"":t.slice(0,e)}function rk(t,e){const n=e.split("/").filter(s=>s.length>0).join("/");return t.length===0?n:t+"/"+n}function sy(t){const e=t.lastIndexOf("/",t.length-2);return e===-1?t:t.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ik(t,e){return e}class Ze{constructor(e,n,s,r){this.server=e,this.local=n||e,this.writable=!!s,this.xform=r||ik}}let Ei=null;function ok(t){return!al(t)||t.length<2?t:sy(t)}function ry(){if(Ei)return Ei;const t=[];t.push(new Ze("bucket")),t.push(new Ze("generation")),t.push(new Ze("metageneration")),t.push(new Ze("name","fullPath",!0));function e(i,o){return ok(o)}const n=new Ze("name");n.xform=e,t.push(n);function s(i,o){return o!==void 0?Number(o):o}const r=new Ze("size");return r.xform=s,t.push(r),t.push(new Ze("timeCreated")),t.push(new Ze("updated")),t.push(new Ze("md5Hash",null,!0)),t.push(new Ze("cacheControl",null,!0)),t.push(new Ze("contentDisposition",null,!0)),t.push(new Ze("contentEncoding",null,!0)),t.push(new Ze("contentLanguage",null,!0)),t.push(new Ze("contentType",null,!0)),t.push(new Ze("metadata","customMetadata",!0)),Ei=t,Ei}function ak(t,e){function n(){const s=t.bucket,r=t.fullPath,i=new at(s,r);return e._makeStorageReference(i)}Object.defineProperty(t,"ref",{get:n})}function ck(t,e,n){const s={};s.type="file";const r=n.length;for(let i=0;i<r;i++){const o=n[i];s[o.local]=o.xform(s,e[o.server])}return ak(s,t),s}function iy(t,e,n){const s=ny(e);return s===null?null:ck(t,s,n)}function uk(t,e,n,s){const r=ny(e);if(r===null||!al(r.downloadTokens))return null;const i=r.downloadTokens;if(i.length===0)return null;const o=encodeURIComponent;return i.split(",").map(u=>{const l=t.bucket,h=t.fullPath,f="/b/"+o(l)+"/o/"+o(h),g=ul(f,n,s),y=Ym({alt:"media",token:u});return g+y})[0]}function lk(t,e){const n={},s=e.length;for(let r=0;r<s;r++){const i=e[r];i.writable&&(n[i.server]=t[i.local])}return JSON.stringify(n)}class oy{constructor(e,n,s,r){this.url=e,this.method=n,this.handler=s,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ay(t){if(!t)throw ol()}function hk(t,e){function n(s,r){const i=iy(t,r,e);return ay(i!==null),i}return n}function fk(t,e){function n(s,r){const i=iy(t,r,e);return ay(i!==null),uk(i,r,t.host,t._protocol)}return n}function cy(t){function e(n,s){let r;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?r=CA():r=SA():n.getStatus()===402?r=IA(t.bucket):n.getStatus()===403?r=AA(t.path):r=s,r.status=n.getStatus(),r.serverResponse=s.serverResponse,r}return e}function dk(t){const e=cy(t);function n(s,r){let i=e(s,r);return s.getStatus()===404&&(i=TA(t.path)),i.serverResponse=r.serverResponse,i}return n}function pk(t,e,n){const s=e.fullServerUrl(),r=ul(s,t.host,t._protocol),i="GET",o=t.maxOperationRetryTime,a=new oy(r,i,fk(t,n),o);return a.errorHandler=dk(e),a}function gk(t,e){return t&&t.contentType||e&&e.type()||"application/octet-stream"}function mk(t,e,n){const s=Object.assign({},n);return s.fullPath=t.path,s.size=e.size(),s.contentType||(s.contentType=gk(null,e)),s}function yk(t,e,n,s,r){const i=e.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function a(){let j="";for(let L=0;L<2;L++)j=j+Math.random().toString().slice(2);return j}const c=a();o["Content-Type"]="multipart/related; boundary="+c;const u=mk(e,s,r),l=lk(u,n),h="--"+c+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xn{constructor(e,n){this._service=e,n instanceof at?this._location=n:this._location=at.makeFromUrl(n,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,n){return new Xn(e,n)}get root(){const e=new at(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return sy(this._location.path)}get storage(){return this._service}get parent(){const e=sk(this._location.path);if(e===null)return null;const n=new at(this._location.bucket,e);return new Xn(this._service,n)}_throwIfRoot(e){if(this._location.path==="")throw LA(e)}}function _k(t,e,n){t._throwIfRoot("uploadBytes");const s=yk(t.storage,t._location,ry(),new hn(e,!0),n);return t.storage.makeRequestWithTokens(s,uy).then(r=>({metadata:r,ref:t}))}function Ek(t,e,n=wt.RAW,s){t._throwIfRoot("uploadString");const r=Jm(n,e),i=Object.assign({},s);return i.contentType==null&&r.contentType!=null&&(i.contentType=r.contentType),_k(t,r.data,i)}function bk(t){t._throwIfRoot("getDownloadURL");const e=pk(t.storage,t._location,ry());return t.storage.makeRequestWithTokens(e,uy).then(n=>{if(n===null)throw xA();return n})}function Tk(t,e){const n=rk(t._location.path,e),s=new at(t._location.bucket,n);return new Xn(t.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hy="storage";function hR(t,e,n,s){return t=Ae(t),Ek(t,e,n,s)}function fR(t){return t=Ae(t),bk(t)}function dR(t,e){return t=Ae(t),Ck(t,e)}function pR(t=tu(),e){t=Ae(t);const s=ko(t,hy).getImmediate({identifier:e}),r=Vd("storage");return r&&kk(s,...r),s}function kk(t,e,n,s={}){Ak(t,e,n,s)}function Rk(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new ll(n,s,r,e,Us)}function Dk(){zn(new _n(hy,Rk,"PUBLIC").setMultipleInstances(!0)),Rt(kf,Rf,""),Rt(kf,Rf,"esm2017")}Dk();export{sR as A,pR as B,dR as C,hR as D,rR as E,fR as F,gd as G,Yk as H,aR as I,Pc as J,Kk as K,tR as L,nR as M,Jf as N,Mk as O,jk as P,St as Q,Bk as R,$k as S,Ok as T,Oc as U,lR as V,Xk as W,Gk as X,gp as Y,qk as Z,Qk as _,Fk as a,zk as b,Uk as c,uR as d,cR as e,dd as f,Zk as g,Lk as h,lE as i,Dd as j,st as k,or as l,Hk as m,Vk as n,tw as o,Pk as p,xk as q,Vr as r,Jk as s,ow as t,Wk as u,eR as v,mv as w,oR as x,iR as y,QS as z};
